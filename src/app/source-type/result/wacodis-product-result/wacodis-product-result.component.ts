...
@Component({
  selector: 'wacodis-product-result',
  templateUrl: './wacodis-product-result.component.html',
  styleUrls: ['./wacodis-product-result.component.scss']
})

export class WacodisProductResultComponent implements OnInit {
